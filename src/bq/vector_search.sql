...
-- Project: YOUR_PROJECT_ID | Dataset: pci_vector_search | Table: users_10k
-- =========================================================================
...
SELECT
  ...
  index_type
FROM
  `YOUR_PROJECT_ID.pci_vector_search.INFORMATION_SCHEMA.VECTOR_INDEXES`;
...
FROM
  VECTOR_SEARCH(
    TABLE `YOUR_PROJECT_ID.pci_vector_search.users_10k`,
    'embedding',
    (SELECT user_id, embedding FROM `YOUR_PROJECT_ID.pci_vector_search.users_10k` WHERE user_id = 'usr_000001'),
    top_k => 10,
